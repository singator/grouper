---
title: "Related work and grouper"
output:
  rmarkdown::html_vignette:
    toc: true
    toc_depth: 2
vignette: >
  %\VignetteIndexEntry{Related work and grouper}
...
and application. In our examples, we utilise the `gplk` solver. However, for 
more complicated problems, we highly recommend the `gurobi` solver.
