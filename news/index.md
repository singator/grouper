...
- Added a PhD workload allocation model, with associated extraction and
  post-processing functions.
- Modularized model preparation and added a wrapper for easier use.
- Updated `data/` testing datasets for the PhD model.
- Added a PhD-model vignette and expanded sanity checks to include a
  sample workflow.
...
- Vignette examples added for above, and to demonstrate use of arrays in
  YAML file.
